      ...
      try {
        ...
        switch (query) {
          case "":
            // 뉴스 API 주소 전체 주제
            const response = await axios.get(
              `https://newsapi.org/v2/top-headlines?country=kr&apiKey=6af3420673e44e20bca25e3273809da9`
            );
          ...
          case "&category=business":
            ...
            const response_business = await axios.get(
              `https://newsapi.org/v2/top-headlines?country=kr${query}&apiKey=6af3420673e44e20bca25e3273809da9`
            );
